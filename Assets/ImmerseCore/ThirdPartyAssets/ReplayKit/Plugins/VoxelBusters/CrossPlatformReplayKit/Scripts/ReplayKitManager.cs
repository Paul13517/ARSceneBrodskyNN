...
namespace VoxelBusters.ReplayKit
{
    ...
    public class ReplayKitManager
    {
        ...
        private static ReplayKitDelegates.OnPrepareRecordingFinished m_onPrepareRecordingFinished;
        ...
        private static event ReplayKitDelegates.PrepareRecordingStateChangedCallback DidPrepareRecordingStateChange;
        ...
        public static void Initialise()
        {
            if (!ReplayKitInternal.Instance.IsInitialised())
            {
                ...
                ReplayKitInternal.Instance.DidPrepareRecordingStateChangeEvent -= OnDidPrepareRecordingStateChange;
        ...
        public static void PrepareRecording(ReplayKitDelegates.OnPrepareRecordingFinished callback = null)
        {
        ...
        private static void OnDidPrepareRecordingStateChange(ReplayKitPrepareRecordingState state, string message)
        {
            DidPrepareRecordingStateChange?.Invoke(state, message);

            if (state == ReplayKitPrepareRecordingState.Failed)
            {
                if (m_onPrepareRecordingFinished != null)
                    m_onPrepareRecordingFinished(message);
