...
namespace VoxelBusters.ReplayKit
{
    ...
    public class ReplayKitDelegates
	{
        ...
        public delegate void PrepareRecordingStateChangedCallback(ReplayKitPrepareRecordingState state, string error);
        public delegate void OnPrepareRecordingFinished(string error);
