...
namespace VoxelBusters.ReplayKit
{
    ...
    internal partial class ReplayKitInternal : SingletonPattern<ReplayKitInternal>, INativeCallbackListener
    {
        ...
        public  event ReplayKitDelegates.PrepareRecordingStateChangedCallback       DidPrepareRecordingStateChangeEvent;
        ...
        public void OnPrepareRecordingStarted()
        {

            Dispatch(() =>
            {
                DidPrepareRecordingStateChangeEvent?.Invoke(ReplayKitPrepareRecordingState.Started, string.Empty);
            });
        }

        public void OnPrepareRecordingFinished()
        {

            Dispatch(() =>
            {
                DidPrepareRecordingStateChangeEvent?.Invoke(ReplayKitPrepareRecordingState.Finished, string.Empty);
            });
        }

        public void OnPrepareRecordingFailed(string message)
        {

            Dispatch(() =>
            {
                DidPrepareRecordingStateChangeEvent?.Invoke(ReplayKitPrepareRecordingState.Failed, message);
            });
        }
