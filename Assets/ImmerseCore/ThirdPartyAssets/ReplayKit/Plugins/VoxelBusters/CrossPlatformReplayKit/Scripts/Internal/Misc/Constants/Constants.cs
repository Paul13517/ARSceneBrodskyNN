...
namespace VoxelBusters.ReplayKit.Internal
{
	public class Constants : MonoBehaviour
	{
		...
		public const string	kRootAssetsPath						= "Assets/ImmerseCore/ThirdPartyAssets/ReplayKit";
		public const string	kVBCodebasePath						= "Assets/ImmerseCore/ThirdPartyAssets/ReplayKit/Plugins/VoxelBusters";
